    ...
    <div class="row gx-0 d-none d-lg-flex">
      <div class="col-lg-7 px-5 text-start">
        <div class="h-100 d-inline-flex align-items-center me-4">
          <small class="fa fa-envelope text-secondary me-2">Kpspices46@gmail.com</small>
        </div>
  ...
  <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
    <a href="index.php" class="navbar-brand d-flex align-items-center px-4 px-lg-5">
      <h2 class="m-0 text-secondary"></i>KP SPICES TRADING </h2>
    </a>
      ...
      <div class="navbar-nav ms-auto p-4 p-lg-0">
        ...
        <div class="nav-item dropdown">
          ...
          <div class="dropdown-menu fade-up m-0">
            <a href="Badli_Elachi.php" class="dropdown-item">Badli Elachi</a>
            <a href="Amritha.php" class="dropdown-item">8mm Amritha</a>
            <a href="Dry_Fruits.php" class="dropdown-item">Dry Fruits</a>
            <a href="Green_Cardamom.php" class="dropdown-item">Green Cardamom</a>
