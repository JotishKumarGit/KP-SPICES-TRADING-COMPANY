...
<script>
    function sendToWhatsApp() {
        ...
        const phoneNumber = "919961152555"; // <-- apna number yahan daalein
...
<script>
    document.getElementById("enquiryForm").addEventListener("submit", function(e) {
        ...
        const phoneNumber = "919961152555";
    ...
    <div class="container py-5">
      <div class="row g-5">
        ...
        <div class="col-lg-3 col-md-6">
          <h4 class="text-light mb-4">KP SPICES TRADING COMPANY</h4>
          <p class="text-start">
            KP Spices Trading Company is a trusted exporter of premium-quality spices, delivering authentic flavors from India to kitchens around the world.
          </p>
        </div>
        ...
        <div class="col-lg-3 col-md-6">
          ...
          <p class="mb-2">
            <i class="fa fa-map-marker-alt me-3"></i> KP Building., Chennattumattam junction, Kattappana
          </p>
          <p class="mb-2">
            <i class="fa fa-phone-alt me-3"></i>+91 9961152555
          </p>
          <p class="mb-2"><i class="fa fa-envelope me-3"></i>Kpspices46@gmail.com</p>
      ...
      <div class="copyright">
        <div class="row">
          <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
            &copy; <a class="border-bottom" href="#">KP SPICES TRADING COMPANY</a>, All
